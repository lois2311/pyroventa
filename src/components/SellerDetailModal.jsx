...
export default function SellerDetailModal({ sellerId, sellerName, date, locationId, onClose }) {
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500">Detalle de ventas · {date || 'Hoy'}</p>
          </div>
